...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //2.通过客户对象提取客户信息，当该客户不存在时，创建客户(根据公司的名字精确匹配，判断该客户是否存在)
        ...
        //经过第二步处理后，客户信息已经有了，将来在处理其他表的时候，如果要使用到可获得id，直接使用cus.getId
        ...
        //经过第三步处理后,联系人信息已经有了，将来在处理其他表的时候，如果要使用联系人的id，直接使用con.getId
        //4.通过b备注转换到客户备注以及联系人备注
        //查询出该线索的备注信息列表
        List<ClueRemark> clueRemarkList = clueRemarkDao.getListByClueId(clueId);
        for (ClueRemark clueRemark: clueRemarkList) {

            //取出备注信息(主要转换到备注和联系人备注的就是这个备注信息)
        ...
        if(t!=null){
            ...
            /*
                接下来可以通过第一步生成的c对象取出一些信息，继续完善t对象的封装
             */
